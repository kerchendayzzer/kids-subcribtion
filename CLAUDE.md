...
- Цены в `Pricing.tsx`: Старт — 1490 ₽/мес, Оптимум — 2490 ₽/мес, Максимум — 4490 ₽/мес. Переключатель длительности пересчитывает цену с учётом скидки (–5% за 3 мес, –10% за 12 мес)
